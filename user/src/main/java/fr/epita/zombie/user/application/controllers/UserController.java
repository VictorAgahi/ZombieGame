...
public class UserController {
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(responseCode = "400", description = "Registration failed: invalid request", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Profile found and returned", content = @Content(schema = @Schema(implementation = UserResponse.class))),
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Profile successfully updated", content = @Content(schema = @Schema(implementation = UserResponse.class))),
